...
if(isset($_POST['submit'])){
    ...
    if ( $user->isValidUsername($username)){
        ...
        if($user->login($username,$password)){
            ...
            header('Location: http://localhost:8080/loputoo/myAccount.php');
            exit;
        } else {
...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="tournament-login-right col-sm-6 table-cell-content-center">
                <div>
            ...
            <div class="tournament-user-login-form-wrapper col-sm-6">
                <form role="form" method="post" action="" autocomplete="off">
                    <h2>Please Login</h2>
                    <p><a href='http://localhost:8080/loputoo/'>Back to home page</a></p>
                    <hr>
